...
VL_ATTR_COLD void Vtop___024root___eval_initial(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__top__DOT__IDU__DOT__is_jump_type 
        = vlSelf->top__DOT__IDU__DOT__is_jump_type;
    vlSelf->__Vtrigrprev__TOP__top__DOT__jalr = vlSelf->top__DOT__jalr;
...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__IDU__DOT__is_bgeu = (IData)((0x7063U 
                                                   ...
                                                   (0x707fU 
                                                    & vlSelf->inst)));
    vlSelf->top__DOT__IDU__DOT__is_jump_type = (0x6fU 
                                                == 
                                                (0x7fU 
                                                 & vlSelf->inst));
    ...
    vlSelf->top__DOT__IDU__DOT____VdfgExtracted_h834c0bbe__0 
        = ((IData)(vlSelf->top__DOT__jalr) | (IData)(vlSelf->top__DOT__IDU__DOT__is_jump_type));
                                             ...
                                             : (((0x342U 
                                                ...
                                                ((IData)(vlSelf->top__DOT__IDU__DOT__is_ecall)
                                                 ...
                                                 ((IData)(vlSelf->top__DOT__IDU__DOT__is_mret)
                                                   ? vlSelf->top__DOT__CSR__DOT__csr_mepc
                                                   : 0U))))));
    vlSelf->top__DOT__IDU__DOT__is_add_type = ((0x17U 
                                                == 
                                                (0x7fU 
                                                 & vlSelf->inst)) 
                                               | ((IData)(vlSelf->top__DOT__IDU__DOT__is_jump_type) 
                                                         ...
                                                         | ((IData)(vlSelf->top__DOT__IDU__DOT__is_xor) 
                                                            | ((IData)(vlSelf->top__DOT__IDU__DOT__is_srl) 
                                                               | ((IData)(vlSelf->top__DOT__IDU__DOT__is_sra) 
                                                                  | ((IData)(vlSelf->top__DOT__IDU__DOT__is_or) 
                                                                     | (IData)(vlSelf->top__DOT__IDU__DOT__is_and))))))))));
    vlSelf->top__DOT__jump_en = ((IData)(vlSelf->top__DOT__jump_branch) 
                                 | ((IData)(vlSelf->top__DOT__IDU__DOT__is_jump_type) 
    ...
    vlSelf->top__DOT__alu_b_sel = ((IData)(vlSelf->top__DOT__IDU__DOT__is_r_type)
                                    ? 0U : ((IData)(vlSelf->top__DOT__IDU__DOT__is_csrrs)
                                            ...
                                            ((IData)(vlSelf->top__DOT__IDU__DOT__is_csrrw)
                                              ? 2U : 3U)));
    vlSelf->top__DOT__w_en = ((IData)(vlSelf->top__DOT__IDU__DOT__is_u_type) 
                              | ((IData)(vlSelf->top__DOT__IDU__DOT__is_jump_type) 
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(0U)) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge top.IDU.is_jump_type)\n");
    }
    if (vlSelf->__VactTriggered.at(1U)) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge top.jalr)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge top.IDU.is_jump_type)\n");
    }
    if (vlSelf->__VnbaTriggered.at(1U)) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge top.jalr)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__w_en = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__IDU__DOT__is_add_type = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__IDU__DOT__is_u_type = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__IDU__DOT__is_jump_type = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vtrigrprev__TOP__top__DOT__IDU__DOT__is_jump_type = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigrprev__TOP__top__DOT__jalr = VL_RAND_RESET_I(1);
