...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+180,"alu_b", false,-1, 31,0);
    tracep->declBus(c+181,"alu_out", false,-1, 31,0);
    ...
    tracep->declBus(c+150,"mem_rd_data", false,-1, 31,0);
    tracep->declBus(c+182,"r_csr_data", false,-1, 31,0);
    ...
    tracep->declBus(c+151,"jump_pc", false,-1, 31,0);
    ...
    tracep->declBus(c+180,"SrcB", false,-1, 31,0);
    tracep->declBus(c+35,"alu_func", false,-1, 3,0);
    tracep->declBus(c+181,"ALUout", false,-1, 31,0);
    tracep->declBus(c+32,"signed_a", false,-1, 31,0);
    tracep->declBus(c+180,"signed_b", false,-1, 31,0);
    tracep->declBus(c+32,"unsigned_a", false,-1, 31,0);
    tracep->declBus(c+180,"unsigned_b", false,-1, 31,0);
    tracep->declBus(c+152,"a0", false,-1, 31,0);
    tracep->declBus(c+153,"a1", false,-1, 31,0);
    tracep->declBus(c+154,"a2", false,-1, 31,0);
    tracep->declBus(c+155,"a3", false,-1, 31,0);
    tracep->declBus(c+156,"a4", false,-1, 31,0);
    tracep->declBus(c+157,"a5", false,-1, 31,0);
    tracep->declBus(c+158,"a6", false,-1, 31,0);
    tracep->declBus(c+159,"a7", false,-1, 31,0);
    tracep->declBus(c+160,"a8", false,-1, 31,0);
    ...
    tracep->declBus(c+161,"a13", false,-1, 31,0);
    tracep->declBus(c+180,"a14", false,-1, 31,0);
    ...
    tracep->declArray(c+162,"lut", false,-1, 575,0);
    ...
    tracep->declBus(c+181,"w_csr_data", false,-1, 31,0);
    tracep->declBit(c+31,"w_csr_en", false,-1);
    tracep->declBit(c+31,"r_csr_en", false,-1);
    tracep->declBit(c+45,"jump_mret", false,-1);
    tracep->declBit(c+44,"jump_ecall", false,-1);
    ...
    tracep->declBit(c+86,"is_u_type", false,-1);
    tracep->declBit(c+239,"is_jump_type", false,-1);
    tracep->declBit(c+87,"is_b_type", false,-1);
    tracep->declBit(c+88,"is_r_type", false,-1);
    tracep->declBit(c+89,"is_i_type", false,-1);
    ...
    tracep->declBus(c+90,"out5", false,-1, 31,0);
    tracep->declBus(c+90,"out6", false,-1, 31,0);
    tracep->declBus(c+253,"out7", false,-1, 31,0);
    tracep->declBus(c+90,"out8", false,-1, 31,0);
    ...
    for (int i = 0; i < 8; ++i) {
        tracep->declQuad(c+91+i*2,"pair_list", true,(i+0), 38,0);
    }
    for (int i = 0; i < 8; ++i) {
    ...
    tracep->declBus(c+181,"mem_rd_addr", false,-1, 31,0);
    tracep->declBus(c+181,"mem_wr_addr", false,-1, 31,0);
    tracep->declBus(c+150,"mem_rd_data", false,-1, 31,0);
    tracep->declBus(c+233,"mem_move_out", false,-1, 31,0);
    tracep->declBus(c+234,"mem_out", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("Pc ");
    tracep->declBit(c+235,"clk", false,-1);
    tracep->declBit(c+236,"rst", false,-1);
    tracep->declBit(c+117,"jump_en", false,-1);
    tracep->declBus(c+151,"jump_pc", false,-1, 31,0);
    tracep->declBus(c+238,"pc", false,-1, 31,0);
    tracep->declBus(c+242,"pc_plus4", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+85,(vlSelf->top__DOT__IDU__DOT__is_add_type));
    bufp->fullBit(oldp+86,(vlSelf->top__DOT__IDU__DOT__is_u_type));
    bufp->fullBit(oldp+87,(vlSelf->top__DOT__IDU__DOT__is_b_type));
    bufp->fullBit(oldp+88,(vlSelf->top__DOT__IDU__DOT__is_r_type));
    bufp->fullBit(oldp+89,(vlSelf->top__DOT__IDU__DOT__is_i_type));
    bufp->fullIData(oldp+90,(vlSelf->top__DOT__IMM__DOT__out5),32);
    bufp->fullQData(oldp+91,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__pair_list[0]),39);
    bufp->fullQData(oldp+93,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__pair_list[1]),39);
    bufp->fullQData(oldp+95,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__pair_list[2]),39);
    bufp->fullQData(oldp+97,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__pair_list[3]),39);
    bufp->fullQData(oldp+99,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__pair_list[4]),39);
    bufp->fullQData(oldp+101,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__pair_list[5]),39);
    bufp->fullQData(oldp+103,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__pair_list[6]),39);
    bufp->fullQData(oldp+105,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__pair_list[7]),39);
    bufp->fullIData(oldp+107,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+108,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+109,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+110,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+111,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+112,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__data_list[5]),32);
    bufp->fullIData(oldp+113,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__data_list[6]),32);
    bufp->fullIData(oldp+114,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__data_list[7]),32);
    bufp->fullIData(oldp+115,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+116,(vlSelf->top__DOT__IMM__DOT__imm_mux__DOT__i0__DOT__hit));
    bufp->fullBit(oldp+117,(((IData)(vlSelf->top__DOT__jump_en) 
                             | (IData)(vlSelf->top__DOT__IDU__DOT__is_ecall))));
    bufp->fullIData(oldp+118,(vlSelf->top__DOT__Register__DOT__rf[0]),32);
    bufp->fullIData(oldp+119,(vlSelf->top__DOT__Register__DOT__rf[1]),32);
    bufp->fullIData(oldp+120,(vlSelf->top__DOT__Register__DOT__rf[2]),32);
    bufp->fullIData(oldp+121,(vlSelf->top__DOT__Register__DOT__rf[3]),32);
    bufp->fullIData(oldp+122,(vlSelf->top__DOT__Register__DOT__rf[4]),32);
    bufp->fullIData(oldp+123,(vlSelf->top__DOT__Register__DOT__rf[5]),32);
    bufp->fullIData(oldp+124,(vlSelf->top__DOT__Register__DOT__rf[6]),32);
    bufp->fullIData(oldp+125,(vlSelf->top__DOT__Register__DOT__rf[7]),32);
    bufp->fullIData(oldp+126,(vlSelf->top__DOT__Register__DOT__rf[8]),32);
    bufp->fullIData(oldp+127,(vlSelf->top__DOT__Register__DOT__rf[9]),32);
    bufp->fullIData(oldp+128,(vlSelf->top__DOT__Register__DOT__rf[10]),32);
    bufp->fullIData(oldp+129,(vlSelf->top__DOT__Register__DOT__rf[11]),32);
    bufp->fullIData(oldp+130,(vlSelf->top__DOT__Register__DOT__rf[12]),32);
    bufp->fullIData(oldp+131,(vlSelf->top__DOT__Register__DOT__rf[13]),32);
    bufp->fullIData(oldp+132,(vlSelf->top__DOT__Register__DOT__rf[14]),32);
    bufp->fullIData(oldp+133,(vlSelf->top__DOT__Register__DOT__rf[15]),32);
    bufp->fullIData(oldp+134,(vlSelf->top__DOT__Register__DOT__rf[16]),32);
    bufp->fullIData(oldp+135,(vlSelf->top__DOT__Register__DOT__rf[17]),32);
    bufp->fullIData(oldp+136,(vlSelf->top__DOT__Register__DOT__rf[18]),32);
    bufp->fullIData(oldp+137,(vlSelf->top__DOT__Register__DOT__rf[19]),32);
    bufp->fullIData(oldp+138,(vlSelf->top__DOT__Register__DOT__rf[20]),32);
    bufp->fullIData(oldp+139,(vlSelf->top__DOT__Register__DOT__rf[21]),32);
    bufp->fullIData(oldp+140,(vlSelf->top__DOT__Register__DOT__rf[22]),32);
    bufp->fullIData(oldp+141,(vlSelf->top__DOT__Register__DOT__rf[23]),32);
    bufp->fullIData(oldp+142,(vlSelf->top__DOT__Register__DOT__rf[24]),32);
    bufp->fullIData(oldp+143,(vlSelf->top__DOT__Register__DOT__rf[25]),32);
    bufp->fullIData(oldp+144,(vlSelf->top__DOT__Register__DOT__rf[26]),32);
    bufp->fullIData(oldp+145,(vlSelf->top__DOT__Register__DOT__rf[27]),32);
    bufp->fullIData(oldp+146,(vlSelf->top__DOT__Register__DOT__rf[28]),32);
    bufp->fullIData(oldp+147,(vlSelf->top__DOT__Register__DOT__rf[29]),32);
    bufp->fullIData(oldp+148,(vlSelf->top__DOT__Register__DOT__rf[30]),32);
    bufp->fullIData(oldp+149,(vlSelf->top__DOT__Register__DOT__rf[31]),32);
    bufp->fullIData(oldp+150,(((4U & (IData)(vlSelf->top__DOT__memory_rd_ctrl))
                                    ...
                                    : ((1U & (IData)(vlSelf->top__DOT__memory_rd_ctrl))
                                        ? (((- (IData)(
                                           ...
                                           | (0xffU 
                                              & vlSelf->top__DOT__MEM__DOT__mem_move_out))
                                        : 0U)))),32);
    bufp->fullIData(oldp+151,(((IData)(vlSelf->top__DOT__jump_en)
    ...
    bufp->fullIData(oldp+154,((VL_LTS_III(32, vlSelf->top__DOT__ALU__DOT__signed_a, vlSelf->top__DOT__ALU__DOT__signed_b)
                                ? 1U : 0U)),32);
    ...
    bufp->fullIData(oldp+159,((vlSelf->top__DOT__ALU__DOT__signed_a 
                               & vlSelf->top__DOT__ALU__DOT__signed_b)),32);
    bufp->fullIData(oldp+160,((vlSelf->top__DOT__ALU__DOT__signed_a 
                               - vlSelf->top__DOT__ALU__DOT__signed_b)),32);
    bufp->fullIData(oldp+161,(VL_SHIFTRS_III(32,32,5, vlSelf->top__DOT__ALU__DOT__signed_a, 
                                             (0x1fU 
                                              & vlSelf->top__DOT__ALU__DOT__signed_b))),32);
    ...
    __Vtemp_hcf9c2e3d__0[0x11U] = ((vlSelf->top__DOT__ALU__DOT__signed_a 
                                    + vlSelf->top__DOT__ALU__DOT__signed_b) 
                                   >> 4U);
    bufp->fullWData(oldp+162,(__Vtemp_hcf9c2e3d__0),576);
    bufp->fullIData(oldp+180,(vlSelf->top__DOT__ALU__DOT__signed_b),32);
    bufp->fullIData(oldp+181,(vlSelf->top__DOT__alu_out),32);
    bufp->fullIData(oldp+182,(vlSelf->top__DOT__r_csr_data),32);
    bufp->fullIData(oldp+183,(vlSelf->top__DOT__w_data),32);
    bufp->fullQData(oldp+184,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[0]),36);
    bufp->fullQData(oldp+186,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[1]),36);
    bufp->fullQData(oldp+188,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[2]),36);
    bufp->fullQData(oldp+190,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[3]),36);
    bufp->fullQData(oldp+192,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[4]),36);
    bufp->fullQData(oldp+194,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[5]),36);
    bufp->fullQData(oldp+196,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[6]),36);
    bufp->fullQData(oldp+198,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[7]),36);
    bufp->fullQData(oldp+200,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[8]),36);
    bufp->fullQData(oldp+202,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[9]),36);
    bufp->fullQData(oldp+204,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[10]),36);
    bufp->fullQData(oldp+206,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[11]),36);
    bufp->fullQData(oldp+208,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[12]),36);
    bufp->fullQData(oldp+210,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[13]),36);
    bufp->fullQData(oldp+212,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[14]),36);
    bufp->fullQData(oldp+214,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__pair_list[15]),36);
    bufp->fullIData(oldp+216,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+217,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+218,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+219,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+220,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+221,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[5]),32);
    bufp->fullIData(oldp+222,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[6]),32);
    bufp->fullIData(oldp+223,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[7]),32);
    bufp->fullIData(oldp+224,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[8]),32);
    bufp->fullIData(oldp+225,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[9]),32);
    bufp->fullIData(oldp+226,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[10]),32);
    bufp->fullIData(oldp+227,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[11]),32);
    bufp->fullIData(oldp+228,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[12]),32);
    bufp->fullIData(oldp+229,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[13]),32);
    bufp->fullIData(oldp+230,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[14]),32);
    bufp->fullIData(oldp+231,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__data_list[15]),32);
    bufp->fullIData(oldp+232,(vlSelf->top__DOT__ALU__DOT__alumux__DOT__i0__DOT__lut_out),32);
    bufp->fullIData(oldp+233,(vlSelf->top__DOT__MEM__DOT__mem_move_out),32);
    bufp->fullIData(oldp+234,(vlSelf->top__DOT__MEM__DOT__mem_out),32);
